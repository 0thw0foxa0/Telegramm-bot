...
Questions_table = 'CREATE TABLE IF NOT EXISTS Questions (id integer  primary key autoincrement, user_id varchar(255), tag_id integer, data blob unique, active bool default true, evaluation int default 0, FOREIGN KEY (user_id) REFERENCES Users(user_id),FOREIGN KEY (tag_id) REFERENCES Tags(id))'
